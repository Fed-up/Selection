        ...
        <section id=""class="section__points row">
            ...
            <div class="columns small-12 medium-4 end">
                <article class="points">
                    <div id="1" class="iconbox">
                        <div id="2" class="iconbox__content">
                            <a href="http://www.fedupproject.com.au"><img src="/images/selection/fedup.png" alt="Fed Up Project"/></a>
                            <!-- <p>Fed Up Project</p> -->
                        </div>
                    </div>
                </article>
        ...
        @if(!empty($insta_array))
            <div class=" section__white--insta"> 
                <section class="row ">
                    ...
                    <div href="https://instagram.com/sonaughtybutnice" class="columns small-4 large-2 end">
                        <a href="https://instagram.com/sonaughtybutnice" class="image-box">
                            <img src="{{$image['images']['low_resolution']['url']}}"> </img></a>   
                        </a>
                    </div>
                    @endforeach
                </section>

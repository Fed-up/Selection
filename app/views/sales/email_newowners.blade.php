...
<head>
   ...
   <title>Selection Cafe - Under New Management</title>
   <style type="text/css">
   	a {color: #4A72AF;}
		...
		<tr>
			<td>
				<table id="header" cellpadding="10" cellspacing="0" align="center" bgcolor="#91dd50">
					...
					<tr>
						<td width="570" bgcolor="#91dd50" ><h2 style="color:#ffffff!important">Takes over Selection Cafe</h2></td>
					</tr>
				...
				<table id="content-1" cellpadding="0" cellspacing="0" align="center">
					<tr>
						...
						<td width="375" valign="top" colspan="3">
							<h3 style="text-align:center;">Introducing Sarah & Tom</h3>
							<h5 style="text-align:center;">"Let's brighten up Selection Cafe"</h5>
						</td>
					</tr>
				</table><!-- content 1 -->
			</td>
